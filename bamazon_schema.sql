...
INSERT INTO products
    ...
    VALUES 
    ('1','Mizuno Wave Runner 10', 'Clothing, Shoes', '89.55', '20'),
    ('2','Orthopedic Pet Bed, SM', 'Pet Supplies', '25.50', '116'),
    ('3','Orthopedic Pet Bed, MED', 'Pet Supplies', '25.50', '6'),
    ('4','Orthopedic Pet Bed, LG', 'Pet Supplies', '35.99', '157'),
    ('5','Dog Car Seat Cover', 'Pet Supplies', '28.75', '88'),
    ('6','CamelBak Water Bottle', 'Sports, Outdoors', '24.88', '23'),
    ('7','HS Backpack', 'Sports, Outdoors', '124.99', '50'),
    ('8','HS Backpack, Deluxe', 'Sports, Outdoors', '144.99', '50'),
    ('9','Brooks Adrenaline GTS', 'Clothing, Shoes', '68.50', '135'),
    ('10','Nikon D5600 Digital SLR', 'Electronics', '564.88', '90'),
    ...
    ('13','GoYoga Yoga Mat', 'Sports, Fitness', '16.56', '33'),
